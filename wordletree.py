...
def get_any_better_guess(guesses, answers, beat, max_depth=6, postfix="root"):
    ...
    for (weight, guess, distr) in tqdm.tqdm(guess_order, unit="bucket", leave=False, postfix=postfix, ncols=120):
        guess_tree = {}
        guess_total = 0.
        guessed_count = 0
        len_distr = len(distr)
